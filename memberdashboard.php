      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            <li><a href="memberdashboard.php"> <i class="icon-home"></i>Home   
    ...
    <div class="page">
      ...
      <section >
                    ...
                    <?php
						...
						// }
						$count=$i*3;
                        $sql= "SELECT * FROM `post` ORDER BY `date_created` DESC limit ".$count;
      ...
      <section ><form align='center' method="post"><button type="submit" class="btn btn-danger" id="more" name="more" >More</button></form></section>
      <section ></section>
      <section ></section>
